# # import os
# # import random
# # input_path = "C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Data-set\\Videos\\sclapal\\New folder"
# # output_path = "C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Data-set\\Videos\\sclapal\\New folder\\randomSelect"
...
# #
# #
# # folder =  "C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Data-set\\Videos\\sclapal\\New folder"
# #
# # a=random.choice(os.listdir(folder))
# # print(a)
# #
# # src_dir = "C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Data-set\\Videos\\sclapal"
# # dst_dir = "C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Data-set\\Videos\\sclapal\\outputImages"
...
# # files_list = []
# #
# # for root, dirs, files in os.walk("C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Data-set\\Videos\\sclapal"):
# #     for file in files:
# #         #all
...
# #
# # # print files_list
# # filesToCopy = random.sample(files_list, 5000)  #prints two random files from list
# #
# # destPath = "C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Data-set\\Videos\\random-scalpel\\randomSelect"
# #
...
# # #
# # # for src_path in filesToCopy:
# # #     shutil.copy(src_path, os.path.join(destPath, os.path.basename(src_path)))
#
# import cv2
# video_name = "C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Data-set\\Videos\\sclapal\\IMG_0017.MOV" # or any other extension like .avi etc
...
startb = Button(window, text="START", command=start_fun, font=("Arial", 25), bg="orange", fg="blue", borderwidth=3,
                relief="raised")
startb.place(x=130, y=550)

# image on the main window
path = "C:\\Users\\HP\\Desktop\\Office work\\Surgical-tray\\Video_to-image-convertor-APP\\Images\\front.jpg"
...
lbl1 = tk.Label(text="Select any video &\nget number of Images from video...", font=("Arial", 40),
                fg="green")  # same way bg
lbl1.place(x=80, y=100)

lbl2 = tk.Label(text="Selected Video", font=("Arial", 30), fg="brown")  # same way bg
lbl2.place(x=80, y=260)

path_text = tk.Text(window1, height=1, width=37, font=("Arial", 30), bg="light yellow", fg="orange", borderwidth=2,
                    relief="solid")
